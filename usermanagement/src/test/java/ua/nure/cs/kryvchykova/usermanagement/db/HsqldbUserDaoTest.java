...
public class HsqldbUserDaoTest extends DatabaseTestCase {
	...
	private static final Date DATE_OF_BIRTH_UPDATE2 = new Date(2000-11-20);
	private static final Date DATE_OF_BIRTH_UPDATE = new Date(2000-01-11);
	private static final String LAST_NAME_UPDATE2 = "Ivanova";
	private static final String FIRST_NAME_UPDATE2 = "Inna";
	private static final String FIRST_NAME2 = "Bill";
	private static final String LAST_NAME2 = "Gates";
	private static final long ID = 1000L;

	private static final String LAST_NAME_UPDATE = "Doe";
	private static final String FIRST_NAME_UPDATE = "Joanna";
